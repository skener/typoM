...
{
    /**
     * @var \Skener\Bks\Controller\AuthorController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Skener\Bks\Controller\AuthorController::class)
    ...
    {
        $author = new \Skener\Bks\Domain\Model\Author();
